...
const NewsletterDetails2DraftbitSupportScreen = props => {
        ...
        handlers={{
          on4xx: fetchData => {
            ...
            try {
              ...
              const valuel1NwmTb8 = false;
              setHas_access(valuel1NwmTb8);
              const access = valuel1NwmTb8;
...
export default withTheme(NewsletterDetails2DraftbitSupportScreen);
