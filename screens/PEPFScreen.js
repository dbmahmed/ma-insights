                            ...
                            >
                              ...
                              >
                                <Checkbox
                                  ...
                                  color={palettes.Brand['Strong Inverse']}
                                  disabled={h_3_to_5 || h_5_to_7 || h_more_7}
                                  size={24}
                                  status={h_less_3}
                                  uncheckedColor={
                              ...
                              >
                                <Checkbox
                                  ...
                                  color={palettes.Brand['Strong Inverse']}
                                  disabled={h_less_3 || h_5_to_7 || h_more_7}
                                  size={24}
                                  status={h_3_to_5}
                                  uncheckedColor={
                              ...
                              >
                                <Checkbox
                                  ...
                                  color={palettes.Brand['Strong Inverse']}
                                  disabled={h_less_3 || h_3_to_5 || h_more_7}
                                  size={24}
                                  status={h_5_to_7}
                                  uncheckedColor={
                              ...
                              >
                                <Checkbox
                                  ...
                                  color={palettes.Brand['Strong Inverse']}
                                  disabled={h_less_3 || h_3_to_5 || h_5_to_7}
                                  size={24}
                                  status={h_more_7}
                                  uncheckedColor={
                            ...
                            >
                              ...
                              >
                                <Checkbox
                                  ...
                                  color={palettes.Brand['Strong Inverse']}
                                  disabled={last_3 || from_3_to_5 || more_7}
                                  size={24}
                                  status={from_5_to_7}
                                  uncheckedColor={
                          ...
                          >
                            ...
                            <XanoCollectionApi.FetchGetAllPEPFGET
                              ...
                              handlers={{
                                on2xx: fetch2Data => {
                                  try {
                                    setPepfItems(fetch2Data?.json?.items);
                                        ...
                                        onEndReached={() => {
                                          const handler = async () => {
                                            try {
                                              ...
                                              setNextPage(
                                                parseInt(nextPage + 1, 10)
                                              );
                                              const newData = (
                                                await XanoCollectionApi.getAllPEPFGET(
                                                  Constants,
                                                  {
                                                    countryIn: country,
                                                    ebitdaIn: ebitdaRange,
                                              ...
                                              setPepfItems(
                                                pepfItems.concat(newData?.items)
                                              );
                                              setLastPage(newData?.pagesTotal);
                                            } catch (err) {
                                              console.error(err);
